    ...
    workspace_add = 'F:\Matlab_Test\3DFaceRecognition-master\'; 
    %For example 'F:\3d_images\project_3d_feature\'
    imgFolder = strcat(workspace_add,'Allmyabsfiles');
    ...
    for k = 1:length(jpegFiles)
        ...
        makePly(mm, 'F:\Matlab_Test\3DFaceRecognition-master\my_cropped.ply');
        ptCloud_cropped = pcread('F:\Matlab_Test\3DFaceRecognition-master\my_cropped.ply');
...
%         makePly(zz_denoised_test,'F:\Matlab_Test\3DFaceRecognition-master\zz_denoised_test.ply');
%         zz_denoised_test = pcread('F:\Matlab_Test\3DFaceRecognition-master\zz_denoised_test.ply');
%         pcshow(zz_denoised_test);
       ...
       % zz_despiked = medfilt3(zz);
        ...
        %Multidimensional data interpolation for filling holes
          ...
          zz_despiked_test = medfilt3([xx,yy,zz]);
          ZI_test = interpn(zz_despiked_test,.9,'cubic');
          zz_denoised_test = imgaussfilt3(ZI_test);
          makePly(zz_denoised_test,'F:\Matlab_Test\3DFaceRecognition-master\zz_denoised_testdfg.ply');
          zz_denoised_test1 = pcread('F:\Matlab_Test\3DFaceRecognition-master\zz_denoised_testdfg.ply');
          pcshow(zz_denoised_test1);
        
        
        %denoising process
%         zz_denoised = imgaussfilt3(ZI(:,3));
%         ZI_test = interpn(zz_despiked,.9,'cubic');
%         zz_denoised_test = imgaussfilt3(ZI_test);
%         makePly(zz_denoised_test,'F:\Matlab_Test\3DFaceRecognition-master\zz_denoised_shaikabdulla.ply');
%         zz_denoisedabdulla = pcread('F:\Matlab_Test\3DFaceRecognition-master\zz_denoised_shaikabdulla.ply');
%         pcshow(zz_denoisedabdulla);
